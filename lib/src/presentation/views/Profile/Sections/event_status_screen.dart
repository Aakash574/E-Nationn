...
class _EventStatusScreenState extends State<EventStatusScreen> {
  ...
  void getUserEventDetails() async {
    ...
    userEventStatus = await UserEventRepository().getUserEventDetails();

    hackathons = await HackathonRepository().getHackathonDetails();
    internships = await InternshipRepository().getInternshipDetails();
    events = await EventRepository().getEventDetails();
    setState(() {});
  }
