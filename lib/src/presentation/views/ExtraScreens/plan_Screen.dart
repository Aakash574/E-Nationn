...
import '../PaymentScreens/voucher_code_screen.dart';
...
class _PlanScreenState extends State<PlanScreen> {
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          setState(() {
                            if (isActive) {
                              msg =
                                  "Hello,\n I want to know more about Basic Plan.";
                            } else {
                              msg =
                                  "Hello,\n I want to know more about Premium Plan.";
                            }

                            _launchWhatsapp("+91 9302707264", msg);
                          });
                        },
                        child: Container(
                          width: size.width / 1.2,
                      ...
                      Container(
                        ...
                        child: TextButton(
                          onPressed: () async {
                            ...
                            basicVariable.setWhichScreen("PlanScreen");
                            log(basicVariable.whichScreen);
                          ...
                          child: MyFont().fontSize16Bold(
                            !isActive && userProvider.planStatus == 'premium'
                                ? "Activated"
                                : isActive && userProvider.planStatus == 'basic'
                                    ? "Activated"
                                    : "Apply",
  ...
  _launchWhatsapp(whatsapp, msg) async {
    var whatsappAndroid =
        Uri.parse("whatsapp://send?phone=$whatsapp&text=$msg");
