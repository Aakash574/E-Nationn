...
import '../PaymentScreens/plan_Screen.dart';
    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          ...
          image:
              AssetImage("assets/PaymentScreenImg/paymentScreenBackground.png"),
          fit: BoxFit.cover,
        ),
      ),
      child: Stack(
        ...
        children: [
          Container(
            ...
            child: Image.asset(
              "assets/ExtrasScreens/planScreen.png", scale: 1.5,
              // scale: 1,
            ),
          ),
          Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              planDetails(Icons.foundation,
                                  "Grounding and Personal Foundation."),
                              planDetails(Icons.checklist_rounded,
                                  "Preparation and Planning."),
                              planDetails(Icons.brightness_auto_outlined,
                                  "Negotiate and Initialize."),
                              planDetails(Icons.support_agent_outlined,
                                  "Support and Enable."),
                              planDetails(Icons.celebration_rounded,
                                  "Closure and Celebration."),
                              planDetails(
                                  Icons.bar_chart_rounded, "enabling growth"),
                            ],
                          ),
                        ),
                        const SizedBox(height: 20),
