...
class BasicMeetingDetailScreeen extends StatefulWidget {
  const BasicMeetingDetailScreeen({
    super.key,
  ...
  @override
  State<BasicMeetingDetailScreeen> createState() =>
      _BasicMeetingDetailScreeenState();
}

class _BasicMeetingDetailScreeenState extends State<BasicMeetingDetailScreeen> {
  @override
