import 'package:enationn/src/data/repos/remote/meetRepository/premium_meet_repository.dart';
import 'package:enationn/src/presentation/views/Dashboard/Meet/Premium/premium_detail_section.dart';
...
class _PremiumSectionState extends State<PremiumSection> {
  ...
  Future<Object> futureCall() async {
    premiumMeetData = await PremiumMeetRepository().getMeetData();

    return await PremiumMeetRepository().getMeetData();
  }
